...
export default function Sidebar() {
  ...
  const navigation = [
    ...
    { name: 'Explorar', href: '/explore', icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    { name: 'Perfil', href: `/profile/${session.user.id}`, icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="hidden md:flex md:flex-col md:w-64 md:fixed md:inset-y-0 pt-16 bg-gray-900 border-r border-gray-800">
        ...
        <nav className="flex-1 px-2 py-4 space-y-1">
          {navigation.map((item) => {
            ...
            return (
              ...
              >
                <div className={`${isActive ? 'text-white' : 'text-gray-400 group-hover:text-white'} mr-3`}>
                  {item.icon}
                </div>
                {item.name}
              </Link>
